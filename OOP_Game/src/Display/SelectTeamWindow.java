...
public class SelectTeamWindow extends JPanel {
	...
	public SelectTeamWindow(Window window) {
		...
		buttonGermany = new JButton(
				new ImageIcon(new ImageIcon(PicGer).getImage().getScaledInstance(250, 250, Image.SCALE_DEFAULT)));
		buttonBrazil = new JButton(
				new ImageIcon(new ImageIcon(PicBra).getImage().getScaledInstance(250, 250, Image.SCALE_DEFAULT)));
		buttonArgentina = new JButton(
				new ImageIcon(new ImageIcon(PicArgen).getImage().getScaledInstance(250, 250, Image.SCALE_DEFAULT)));
